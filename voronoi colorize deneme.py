...
df = pd.read_csv(
    'C:/Users/cagri/Desktop/Python/metrica csv/sample-data-master/data/Sample_Game_1/Sample_Game_1_RawTrackingData_Away_Team.csv',
    low_memory=False)
...
df1 = pd.read_csv(
    'C:/Users/cagri/Desktop/Python/metrica csv/sample-data-master/data/Sample_Game_1/Sample_Game_1_RawTrackingData_Home_Team.csv',
    low_memory=False)
...
arka_plan = pygame.image.load('C:/Users/cagri/Desktop/Python/Saha.PNG')
x = 0
y = 0
i = 5000
while True:
    ...
    if xtop == 0 or ytop == 0:
        xtop = 1930
        ytop = 1090
        # (170,85),(1160,85),(1160,640),(170,640)(x_start,y_start),(x_end,y_start),(x_end,y_end),(x_start,y_end),
    ...
    for region in regions:
        ...
        if ct >= 0:
            ...
            # if region_point[ct] >= 4 and region_point[ct] < 16:
            #if region_point[ct] >= 4 and region_point[ct] < 16:
            #    color = (180, 180, 180)
            # elif region_point[ct] >= 16:
            #elif region_point[ct] >= 16:
             #     color = (100, 100, 20)
            #else:
                #color = (115, 130, 0)
    ...
    pygame.draw.rect(screen, BLACK,
                     ...
                     3)
    pygame.draw.rect(screen, BLACK, (
    x_end - GOAL_AREA_WIDTH, y_start + (y_end - y_start - GOAL_AREA_HEIGHT) / 2, GOAL_AREA_WIDTH + 1, GOAL_AREA_HEIGHT),
                     3)
    ...
    top = pygame.draw.circle(screen, (0, 0, 0), (int(x_start + xtop), int(y_start + ytop)), 5)
        ...
        #   if (ayi[1] == 10 or ayi[1] == 14):

        #    else:
        #       print("atla")
        # if ((start[0] < 0) | (start[0] > 1280) | (start[1] < 0) | (start[1] > 720) | (end[0] < 0) | (end[0] > 1280) | (end[1] < 0) | (end[1] > 720)):
        # else:
    ...
    # pygame.draw.line((x1,y1),(0,0,0),500,500)
    i += 1
    if i == 8000:
        break
